...
const ITEMS = [
  {
    ...
    external: false,
    href: 'mailto:training@idm-b.com?subject=Developer%20certification',
    bg: '#dde2e6',
    photo: 'pro',
  },
  {
    ...
    cta: 'Enrol your team',
    external: true,
    href: 'mailto:training@idm-b.com?subject=Operator%20academy',
    bg: '#d6efde',
    photo: 'foundational',
  },
  {
    ...
    external: true,
    href: 'mailto:training@idm-b.com?subject=Data%20%26%20analytics%20track',
    bg: '#cfe7f8',
    photo: 'students',
  },
] as const;
